...
*/
const calcolaGatti = (gatti, gattiInFila) =>
  `${Math.ceil(gatti / gattiInFila)} file, ${Math.ceil(
    Math.ceil(gatti / gattiInFila) * gattiInFila - gatti
  )} gatti mancanti`;
console.log(calcolaGatti(44, 6));
